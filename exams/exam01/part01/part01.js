    ...
    function changeButtonAndHint(event){
        ...
        if(state === "guess"){
            ...
            if(newTask.length !== 0 && newTask.length !== 5){
                document.querySelector('.hint').innerHTML = "Invalid Word Length";
                ...
                for(let i = 0; i < 5; i++){
                    ...
                    document.querySelector('.hint').innerHTML = "Invalid Letter";
                    document.querySelector('.guess').disabled = true;
                    return;
                }
                document.querySelector('.hint').innerHTML = `<span class="hint"></span>`;
